...
namespace LegendariumData.Migrations
{
    ...
    [Migration("20230110205504_addedResourceToGameMapTile")]
    partial class addedResourceToGameMapTile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegendariumWorld.GameMapItem", b =>
                {
                    ...
                    b.Property<bool>("IsTileMoveable")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LegendariumWorld.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LegendariumWorld.Resource", b =>
                {
                    b.HasOne("LegendariumWorld.Location", null)
                        .WithMany("Resources")
